...
class Assertion {
	 ...
	 */
	static void assertArgValueRange(byte value, byte min, byte max, String valueName) {
	 ...
	 * @exception IllegalArgumentException 引数の値が許容範囲外
	 */
	static void assertArgValueRange(short value, short min, short max, String valueName) {
		if ((value < min) || (value > max)) assertArgValueRangeFail(value, min, max, valueName);
	}
	/**
	 * 引数の値の範囲をテストするアサーション。
	 ...
	 * @exception IllegalArgumentException 引数の値が許容範囲外
	 */
	static void assertArgValueRange(int value, int min, int max, String valueName) {
		if ((value < min) || (value > max)) assertArgValueRangeFail(value, min, max, valueName);
	}
	/**
	 * 引数の値の範囲をテストするアサーション。
	 ...
	 * @exception IllegalArgumentException 引数の値が許容範囲外
	 */
	static void assertArgValueRange(long value, long min, long max, String valueName) {
		if ((value < min) || (value > max)) assertArgValueRangeFail(value, min, max, valueName);
	}
	/**
	 * 引数の値の範囲をテストするアサーション。
	 ...
	 * @exception IllegalArgumentException 引数の値が許容範囲外
	 */
	static void assertArgValueRange(float value, float min, float max, String valueName) {
		if ((value < min) || (value > max)) assertArgValueRangeFail(value, min, max, valueName);
	}
	/**
	 * 引数の値の範囲をテストするアサーション。
	 ...
	 * @exception IllegalArgumentException 引数の値が許容範囲外
	 */
	static void assertArgValueRange(double value, double min, double max, String valueName) {
		if ((value < min) || (value > max)) assertArgValueRangeFail(value, min, max, valueName);
	}
	 ...
	 */
	static void assertArgIndexRange(int value, int count, String valueName) {
	 ...
	 * @exception IndexOutOfBoundsException 引数のインデックス値が許容範囲外だった
	 */
	static void assertArgIndexRange(long value, long count, String valueName) {
		if ((value < 0) || (value >= count)) assertArgIndexRangeFail(value, count, valueName);
	}
	 ...
	 */
	static void assertState(boolean success, String format, Object...args) {
